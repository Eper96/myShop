...
<body> <!-- review.jsp -->
	<section>
		<form name="rform" method="post" action="reviewOk">
			<input type="hidden" name="id" value="${gid}"> <!-- rdto의 id필드에 저장 -->
			<input type="hidden" name="pcode" value="${pcode}">
			<!-- 별점을 가져가는 input태그 -->
			<input type="hidden" name="star">
			<h3 align="center"> 상품평 작성하기 </h3>
			<div>
			...
			<div> <input type="text" name="title" placeholder="한줄 제목 입력"> </div>	<!-- 한줄평 -->
			<div> <textarea name="content" id="content" placeholder="상품평 내용을 적어주세요"> </textarea> </div>	<!-- 내용 -->
			<div><input type="submit" id="submit" value="상품평 작성"></div>
		</form>
	</section>
</body>
</html>