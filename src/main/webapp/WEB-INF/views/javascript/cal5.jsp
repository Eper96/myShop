...
<title>Insert title here</title>
 <style>
  ...
  <script>
   function makeCal(y,m) // class='nalJa'의 index
   {
	   ...
	   calData=calData+" <a href='javascript:makeCal("+y+","+(m-1)+")'> 이전 </a> ";
	   calData=calData+y+"년 "+(m+1)+"월 ";
	   calData=calData+" <a href='javascript:makeCal("+y+","+(m+1)+")'> 다음 </a>";
	   calData=calData+" </caption>";
	   calData=calData+"<tr>";
	   ...
	   for(i=0;i<ju;i++)
	   {
		   ...
		   for(j=0;j<7;j++)
		   {
			   ...
			   {                         
				   calData=calData+" <td class='td' onmouseout=out("+day+") onmouseover='over("+day+")' onclick='nalJaSend("+y+","+m+","+day+")'> "+day+" </td> ";
				   day++;                     
			   }			   
		   }	   
   ...
   var std;
   function nalJaSend(y,m,d) // m은 0~11  =>  +1
   {
	   ...
	   {
		   start.value=nalJa;
		   document.getElementsByClassName("td")[d-1].style.background="purple";
		   document.getElementsByClassName("td")[d-1].style.color="white";
		   std=d-1;
	   }	   
	   else if(start.value!="" && end.value=="")
	   {
		   ...
		   if(ss<ee)
		   {
			   ...
			   for(i=0;i<document.getElementsByClassName("td").length;i++)
			   {
		   ...
		   else if(ss.getTime()==ee.getTime())
			    {
			        ...
			        document.getElementsByClassName("td")[d-1].style.background="white";
					document.getElementsByClassName("td")[d-1].style.color="black";
					std="";
			    }
	   }
   }
